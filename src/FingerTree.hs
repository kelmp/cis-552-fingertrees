...
someToTreeList (Three x y z) =
  someToTreeList (Two x y)
    ++ someToTreeList (Two y z)
    ++ someToTreeList (Two x z)
    ++ [More 3 (Two x y) Nil (One z)]
    ++ [More 3 (Two x z) Nil (One y)]
    ++ [More 3 (Two y z) Nil (One x)]

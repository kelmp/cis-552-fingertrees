...
complain p = name p ++ " has been a " ++ adj p ++ " customer of Not-Disney for "
...
queueLoop q = let len = length q in do
  ...
  input <- getLine
  putStrLn "After hearing your soothing words, the customer heads back to their\
  \ spot in line."
